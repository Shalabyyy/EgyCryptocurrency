...
public class DecentralizedNetwork {
	...
	public static void TestNetwork2(){
		...
		System.out.println("\n Simulating Transaction Validation \n");

		//At the time I was writing this code, the Validation Limit was 2
		//TODO set ValidationLimit Based on (n-2)/k 
		...
		//TODO For now we will hard Code block making 3/5/2020
		System.out.println("\nSimulating Block Creation Proccess \n ");
		System.out.println("Simulating Block Forge \n");
		//TODO every 10 minutes
		network.requestBlocks();
		System.out.println("\nNodes Have Created a Block Draft\n");
